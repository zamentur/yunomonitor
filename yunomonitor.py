...
#                'admin': "Le serveur de nom à l’adresse {ip} est trop lent"},
    ...
    'SMART_NOT_SUPPORTED': {'level': 'warning', 'first': 1, 'frequency': 180, 
                'user': "",
                'admin': "Un disque dur ne supporte pas les fonctionnalités permétant le contrôle de son état de santé."},
    'SMART_DISABLED': {'level': 'error', 'first': 1, 'frequency': 180, 
    ...
    'SMART_HALF_WORKING': {'level': 'error', 'first': 1, 'frequency': 180, 
    ...
    'E_FREE_SPACE': {'level': 'error', 'first': 1, 'frequency': 180, 
    ...
    'W_FREE_SPACE': {'level': 'warning', 'first': 1, 'frequency': 180, 
                'user': "",
